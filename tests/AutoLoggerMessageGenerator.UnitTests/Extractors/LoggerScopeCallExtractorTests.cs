...
internal class LoggerScopeCallExtractorTests : BaseSourceGeneratorTest
{
    ...
    public async Task Extract_WithGivenLoggerScope_ShouldTransformIntoBeginScopeCallObject(string description, string sourceCode, bool isValidCall)
    {
        ...
        var loggerScope = LogCallExtractor.Extract(methodSymbol!, invocationExpression, semanticModel!);
